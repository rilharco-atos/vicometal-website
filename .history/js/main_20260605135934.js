...
const VToast = (function() {
    ...
    function getContainer() {
        if (!container) {
            ...
            container.className = 'vtoast-container';
    ...
    function show(message, type, duration) {
        ...
        toast.className = 'vtoast vtoast-' + type;
        toast.innerHTML =
            '<span class="vtoast-icon">' + (ICONS[type] || ICONS.info) + '</span>' +
            '<span class="vtoast-msg">' + message + '</span>' +
            '<button class="vtoast-close" aria-label="Fechar">&times;</button>';

        var closeBtn = toast.querySelector('.vtoast-close');
        closeBtn.addEventListener('click', function() { dismiss(toast); });

        getContainer().appendChild(toast);
        requestAnimationFrame(function() { toast.classList.add('vtoast-show'); });
    ...
    function dismiss(toast) {
        ...
        toast.classList.remove('vtoast-show');
        toast.classList.add('vtoast-hide');
