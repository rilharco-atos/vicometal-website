...
(function() {
    ...
    class CustomCursor {
        ...
        init() {
            ...
            const interactives = document.querySelectorAll('a, button, .service-card, .project-card, .sector-item, .marquee-tile');
    ...
    // --- Section reveal with smooth transition ---
    function initSectionReveal() {
        var sections = document.querySelectorAll('.section, .marquee-section, .scroll-reveal-wrapper, .services-section');
